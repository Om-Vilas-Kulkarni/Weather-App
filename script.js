...
async function start() {
    ...
    if(w=="Haze"){
        ...
        document.getElementById('div1').innerHTML=`<img src="images/drizzle.png" alt="error loading image">`;
        document.body.style.backgroundImage=`linear-gradient(160deg,rgba(12,12,12,0.2),rgba(12,12,12,0.2)),url('images/drizzling.gif')`;
        document.getElementById('currentclimate').innerHTML = "Light Showers";
        document.getElementById('h12').innerHTML = "High";
    }
